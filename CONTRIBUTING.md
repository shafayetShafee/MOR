...
Conduct](https://github.com/shafayetShafee/MOR/blob/main/CODE_OF_CONDUCT.md).
...
- Use the template
  [other_issue.md](https://github.com/shafayetShafee/MOR/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/shafayetShafee/MOR/issues?q=label%3Abug).
...
- Open a new [Issue](https://github.com/shafayetShafee/MOR/issues/new).
- Use the template
  [bug_report.md](https://github.com/shafayetShafee/MOR/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Perform a [search](https://github.com/shafayetShafee/MOR/issues) to
  see if this enhancement has already been suggested. If it has, add a
  comment to the existing issue instead of opening a new one.

### How do I submit a feature request?

Feature requests are tracked as [GitHub
Issues](https://github.com/shafayetShafee/MOR/issues).

- Open a new [Issue](https://github.com/shafayetShafee/MOR/issues/new).
- Use the template
  [feature_request.md](https://github.com/shafayetShafee/MOR/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
...
7.  Submit a [Pull
    ...
    on the [original
    repo](https://github.com/shafayetShafee/MOR/compare).
